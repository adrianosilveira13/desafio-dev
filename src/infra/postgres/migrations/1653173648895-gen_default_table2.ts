...
export class genDefaultTable21653173648895 implements MigrationInterface {
  name = 'genDefaultTable21653173648895'
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "amount" double precision NOT NULL, "document" character varying NOT NULL, "card" character varying NOT NULL, "store_id" integer NOT NULL, "transaction_type_id" integer NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))')
