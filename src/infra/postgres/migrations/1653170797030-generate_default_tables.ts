...
export class generateDefaultTables1653170797030 implements MigrationInterface {
  name = 'generateDefaultTables1653170797030'
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "date" date NOT NULL, "amount" double precision NOT NULL, "document" character varying NOT NULL, "card" character varying NOT NULL, "storeId" integer, "transactionTypeId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))')
